...
import { SessionsCommandableHttpServiceV1 } from '../services/version1/SessionsCommandableHttpServiceV1';
...
export class SessionsServiceFactory extends Factory {
	...
	public static CommandableHttpServiceDescriptor = new Descriptor("service-sessions", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(SessionsServiceFactory.CommandableHttpServiceDescriptor, SessionsCommandableHttpServiceV1);
